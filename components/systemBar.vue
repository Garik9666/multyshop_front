          ...
          <v-row justify="center">
            <v-col lg="8" md="12" class="py-0">
              <v-row align="center" style="position: relative">
                ...
                <v-col md="3" sm="3" class="hidden-sm-and-down text-center">
                    <div class="q">
                      <div>
                ...
                <v-col cols="5" class="pa-0">
                  <v-row justify="end" class="hidden-sm-and-down" no-gutters >
                    <v-menu :open-on-hover="true" bottom offset-y v-for="(item, i) in leftSide" dark :key="i">
                      <template v-slot:activator="{ on }">
                        <v-btn exact :to="localePath(item.to)" router color="#000" text class="my-2 nav_button" v-on="on" bottom >
                          {{item.title}}
                        </v-btn>
                      </template>
